            ...
            [distribution, { node {
              try {
                ...
                parent_image.inside() {
                  ...
                  new File('packages.txt').eachLine { line ->
                    def pkg = line.trim()
                    if (pkg) {
                      unionBuild << pkg
                    }
                ...
                retry(params.retries as Integer) {
                  ...
                  archiveArtifacts artifacts: "$debian_dir/rules*, $debian_dir/control*, $debian_dir/Dockerfile*, $graphs_dir/*", allowEmptyArchive: true
